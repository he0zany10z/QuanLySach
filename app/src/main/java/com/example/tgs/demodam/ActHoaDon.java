...
public class ActHoaDon extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_hoa_don);
    ...
    public void ADDHoaDon(View view) {
        hoaDonDAO = new HoaDonDAO(ActHoaDon.this);
        try {
            if (validation() < 0) {
                ...
                if (hoaDonDAO.inserHoaDon(hoaDon) > 0) {
                    ...
                    Intent intent = new
                            Intent(ActHoaDon.this,ActHoaDonChiTiet.class);
                    Bundle b = new Bundle();
