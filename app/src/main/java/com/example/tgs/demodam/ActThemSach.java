...
public class ActThemSach extends AppCompatActivity {
    BookDAO bookDAO;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_them_sach);
        setTitle("THÊM SÁCH");
        ...
        spnTheLoai.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                maTheLoai = theLoaiList.get(spnTheLoai.getSelectedItemPosition()).getMaTheLoai();
            }
    ...
    public void showSpinner(View view){
        bookDAO = new BookDAO(ActThemSach.this);
        bookDAO.getAllSach();
    }

    public void getTheLoai(){
        theLoaiDAO = new TheLoaiDAO(ActThemSach.this);
        theLoaiList = theLoaiDAO.getAllTheLoai();
        ArrayAdapter<TheLoai> dataAdapter = new ArrayAdapter<TheLoai>(this, android.R.layout.simple_spinner_item, theLoaiList);
    ...
    public int checkPositionTheLoai(String strTheLoai){
        for (int i = 0; i <theLoaiList.size(); i++){
            if (strTheLoai.equals(theLoaiList.get(i).getMaTheLoai())){
                return i;
            }
        }
        return 0;
